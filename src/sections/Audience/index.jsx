  ...
  <div className="audience-container">
    ...
    <div className="audience-wrapper">
      <span className="audience-explanation">
        ...
        we all have potential digital legacy. This happens because of the presente techonology in our lives and the
        amount of data we produce and is precious to us. So everything a person must have to be part of our public, is
      ...
      <span className="audience-explanation">
        At the adult age, we see that the digital goods have more value, that can be emotional, like memories, and of
